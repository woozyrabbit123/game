...
from .enums import DrugQuality, DrugName, CryptoCoin # Added DrugName, CryptoCoin
from game_configs import PLAYER_STARTING_CASH, PLAYER_MAX_CAPACITY as DEFAULT_PLAYER_MAX_CAPACITY # Import defaults

class PlayerInventory:
    BASE_MAX_CAPACITY = DEFAULT_PLAYER_MAX_CAPACITY # Define as a class attribute

    def __init__(self, max_capacity: int = BASE_MAX_CAPACITY, starting_cash: float = PLAYER_STARTING_CASH):
