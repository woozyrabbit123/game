...
if __name__ == "__main__":
    ...
    ai_rivals_list = [
        ...
        AIRival(name="Dockmaster Jones", primary_drug=DrugName.SPEED, primary_region_name=RegionName.THE_DOCKS, aggression=0.5, activity_level=0.6),
        AIRival(name="Mama Rosa", primary_drug=DrugName.WEED, primary_region_name=RegionName.SUBURBIA, aggression=0.4, activity_level=0.8),
        AIRival(name="Sergei", primary_drug=DrugName.HEROIN, primary_region_name=RegionName.THE_DOCKS, aggression=0.7, activity_level=0.6)
    ]
    ...
    try:
        ...
        pygame_ui.game_loop(player_inv, current_region_instance, game_state_module, game_configs_module)
