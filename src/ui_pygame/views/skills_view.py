...
def draw_skills_view(
        ...
        for idx, (skill_id, skill_def) in enumerate(
            ...
            if idx < len(game_configs_data.SKILL_DEFINITIONS) - 1:
                ...
                pygame.draw.line(
                    ...
                    YALE_BLUE,
                    (text_x_start, line_y),
                    (SCREEN_WIDTH - text_x_start - 60, line_y),
                    1,
                )
    ...
    for (
        button
    ) in skills_buttons:  # These include "Unlock" buttons and the "Back" button
