...
from ..ui_theme import (
    FONT_LARGE, FONT_MEDIUM, YALE_BLUE, PLATINUM, GOLDEN_YELLOW, 
    SILVER_LAKE_BLUE, OXFORD_BLUE, draw_text
)
...
def draw_main_menu(surface: pygame.Surface, buttons: List[Button]):
    ...
    draw_text(surface, "PROJECT NARCO-SYNDICATE", SCREEN_WIDTH // 2, 65, 
              font=FONT_LARGE, color=GOLDEN_YELLOW, center_aligned=True)
    draw_text(surface, "Drug Empire Simulation", SCREEN_WIDTH // 2, 95, 
    ...
    draw_text(surface, "MAIN MENU", SCREEN_WIDTH // 2, 167, 
              font=FONT_MEDIUM, color=PLATINUM, center_aligned=True)
