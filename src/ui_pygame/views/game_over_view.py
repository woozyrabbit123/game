...
from ..ui_theme import (
    FONT_XLARGE, FONT_LARGE_BOLD, # Changed FONT_TITLE to FONT_LARGE_BOLD for game over
    IMPERIAL_RED, PLATINUM, OXFORD_BLUE, YALE_BLUE, RICH_BLACK, # Added RICH_BLACK
...
def draw_game_over_view(
    ...
    # Draw popup box
    draw_panel(surface, popup_rect, OXFORD_BLUE, IMPERIAL_RED, 3) # Use IMPERIAL_RED for border

    # Display Game Over Title
    title_y = popup_y + 40
    draw_text(surface, "GAME OVER", popup_rect.centerx, title_y, 
              font=FONT_XLARGE, color=IMPERIAL_RED, center_aligned=True) # Larger font for title

    # Display the reason/message
    message_y = title_y + FONT_XLARGE.get_linesize() + 30
    draw_text(surface, message, popup_rect.centerx, message_y,
              font=FONT_LARGE_BOLD, color=PLATINUM, center_aligned=True, max_width=popup_width - 60)
