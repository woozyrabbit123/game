...
def draw_upgrades_view(
    ...
    draw_text(surface, "PURCHASE UPGRADES", SCREEN_WIDTH // 2, 70, 
    ...
    draw_text(surface, f"Current Cash: ${player_inventory_data.cash:,.2f}", 
    ...
    if not hasattr(game_configs_data, 'UPGRADE_DEFINITIONS') or not game_configs_data.UPGRADE_DEFINITIONS:
        ...
        draw_text(surface, "UPGRADE_DEFINITIONS missing!", SCREEN_WIDTH // 2, 220, 
    ...
    draw_text(surface, "AVAILABLE UPGRADES", SCREEN_WIDTH // 2, 215, 
