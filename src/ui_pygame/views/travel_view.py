...
from ..ui_theme import (
    FONT_LARGE, FONT_MEDIUM, YALE_BLUE, LIGHT_GREY, PLATINUM, GOLDEN_YELLOW,
    draw_text
)
...
def draw_travel_view(
    ...
    draw_text(surface, "TRAVEL", SCREEN_WIDTH // 2, 70, 
    ...
    draw_text(surface, f"Current Location: {current_region_name}", SCREEN_WIDTH // 2, 145, 
